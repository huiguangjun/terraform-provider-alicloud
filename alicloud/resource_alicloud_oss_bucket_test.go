...
func TestAccAlicloudOssBucketLifeCycleTag(t *testing.T) {
	var v oss.GetBucketInfoResult
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"lifecycle_rule.0.transitions." + hashcode1 + ".days":          "3",
						"lifecycle_rule.0.transitions." + hashcode1 + ".storage_class": string(oss.StorageIA),
						"lifecycle_rule.0.tag.#":                                       "2",
						"lifecycle_rule.0.tag.0.key":                                   "key1",
						"lifecycle_rule.0.tag.0.value":                                 "value1",
						"lifecycle_rule.0.tag.1.key":                                   "key2",
						"lifecycle_rule.0.tag.1.value":                                 "value2",
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"lifecycle_rule.0.transitions." + hashcode1 + ".days":          "3",
						"lifecycle_rule.0.transitions." + hashcode1 + ".storage_class": string(oss.StorageIA),
						"lifecycle_rule.0.tag.#":                                       "1",
						"lifecycle_rule.0.tag.0.key":                                   "key1-1",
						"lifecycle_rule.0.tag.0.value":                                 "value1-1",
						"lifecycle_rule.0.tag.1.key":                                   REMOVEKEY,
						"lifecycle_rule.0.tag.1.value":                                 REMOVEKEY,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"lifecycle_rule.0.transitions." + hashcode1 + ".days":          "3",
						"lifecycle_rule.0.transitions." + hashcode1 + ".storage_class": string(oss.StorageIA),
						"lifecycle_rule.0.tag.#":                                       "0",
						"lifecycle_rule.0.tag.0.key":                                   REMOVEKEY,
						"lifecycle_rule.0.tag.0.value":                                 REMOVEKEY,
