...
* `filter` - (Optional, Available since 1.209.0) Configuration block used to identify objects that a Lifecycle rule applies to. See [`filter`](#lifecycle_rule-filter) below.
